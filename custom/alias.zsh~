...
alias yubilock.enable='sudo mv /etc/udev/rules.d/85-yubikey-screen-lock.rules.disabled /etc/udev/rules.d/85-yubikey-screen-lock.rules > /dev/null 2>&1'
alias yubilock.disable='sudo mv /etc/udev/rules.d/85-yubikey-screen-lock.rules /etc/udev/rules.d/85-yubikey-screen-lock.rules.disabled > /dev/null 2>&1'
