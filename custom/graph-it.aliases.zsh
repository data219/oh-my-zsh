...
alias mount.screwerk.graph='sshfs -o cache=no screwerk-graph:/var/lib/graph ~/share/screwerk-graph'
alias unmount.screwerk.graph='fusermount -u ~/share/screwerk-graph'
alias mount.grapit.graph='sshfs -o cache=no graphit-graph:/home/graph-it/graph ~/share/grapit-graph'
