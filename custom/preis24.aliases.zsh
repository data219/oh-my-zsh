...
alias rsync.to.soprado-dev='rsync -avrz --exclude="var/cache/" --progress -e ssh --exclude=cache --exclude=".git"/home/markmann/workspace/p24-web/ soprado-dev:work/p24-web/'
...
alias rsync.to.soprado-dev2='rsync -avrz --exclude="var/cache/" --progress -e ssh --exclude=cache --exclude=".git"/home/markmann/workspace/p24-web/ soprado-dev:work/p24-web2/'
